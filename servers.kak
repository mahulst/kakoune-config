...
hook -group lsp-filetype-gdscript global BufSetOption filetype=gdscript %{
    set-option buffer lsp_servers %{
        ...
        # # Run Godot as a headless LSP server on stdio
        # command = "godot"
        # args = [
        #   "--headless",
        #   "--editor",
        ...
        # # Godot's LSP uses UTF-16 for offsets
        # offset_encoding = "utf-16"
}
...
# quotePreference = "double"
        ...
        # [vue-language-server]
        # command = "npx"
        # args = ["--no-install", "vue-language-server", "--stdio"]
        # filetypes = ["vue"]
        # root_globs = [
        #     "package.json",
        #     "tsconfig.json",
        ...
        #     ".hg",
        # ]
        # [vue-language-server.initialization_options]
        # typescript = { tsdk = "/Users/mahulst/projects/vue/vuets/node_modules/typescript/lib/" }
    }
}
