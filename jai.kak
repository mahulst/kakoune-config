...
define-command compile-and-run-jai -docstring 'Compile and run Jai file' %{
    evaluate-commands %sh{
        filepath_no_ext="${kak_buffile%.*}"
        echo "run-in-fifo 'jai ${kak_buffile}  && $filepath_no_ext' jai-compile"
    }
}

declare-user-mode jai

map global user -docstring 'jai' j ':enter-user-mode jai<ret>'

map -docstring "Run current file" \
	global jai r %{: compile-and-run-jai <ret>}
